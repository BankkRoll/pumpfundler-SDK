...
Our fee structure is designed to support the ongoing development and maintenance of the PumpFundler SDK. Here's what your fees contribute to:

<Check>Infrastructure costs for maintaining the SDK</Check>
<Check>Ongoing development and improvements</Check>
<Check>Technical support for SDK users</Check>
<Check>Integration with Jito for MEV protection</Check>
...
<AccordionGroup>
  <Accordion title="Why is there a creation fee?">
    The creation fee helps cover the computational resources required to deploy a new token on the Solana blockchain and supports the ongoing development of the SDK.
  </Accordion>
  ...
  <Accordion title="Are there any additional network fees?">
    The fees mentioned here are specific to the PumpFundler SDK. Solana network fees (which are typically very low) will also apply to transactions.
  </Accordion>
</AccordionGroup>
